...
The location returned should be an array (Tuple<int, int> in C#, RAX:RDX in NASM, std::pair<std::size_t, std::size_t> in C++) 
where the first element is the row index, and the second element is the column index of the bomb location (both should be 0 based).
